      ...
      <form method="post" name="createEvent" class="form-horizontal" role="form">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <input type="input" id="event_name" placeholder="Event Name" class="form-control" name="event_name" value="Hiking" required>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-sm-6 col-sm-offset-3">
             <!-- button for modal -->
             <button type="submit" class="btn btn-info" name="registerEvent" style="float: right; margin-right: 35%; width: 25%;" >
             Create Event
           </button>
                           ...
                           <!--  <div class="modal-body">
                              ...
                              <div class="modal-body">
                                ...
                                <div style="display: flex; align-items: center; justify-content: space-around; ">
                                  <button type="submit" class="btn btn-default" data-dismiss="modal" name="registerEvent">
